...
Backend pédagogique pour une appli de prise de RDV (salon de coiffure) — conçu pour que **3 groupes** (Client / Coiffeur / Gérant) travaillent sur **la même base de code**.
...
## 8) Travail en 3 groupes (suggestion)
